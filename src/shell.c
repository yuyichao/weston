...
static void
input_panel_surface_set_transient(struct wl_client *client,
				  struct wl_resource *resource,
				  ...
				  int32_t y)
{
	...
	input_panel_surface = get_input_panel_surface(surface);

	if (!input_panel_surface)
		return;

	input_panel_surface->transient.parent = parent->data;
	input_panel_surface->transient.x = x;
	input_panel_surface->transient.y = y;
}

static const struct input_panel_surface_interface input_panel_surface_implementation = {
	input_panel_surface_set_toplevel,
	input_panel_surface_set_transient
};
